...
public class OSMAPIAdapter {
    ...
    public HashSet<Pitch> fetchPitches(PitchType pitchType) {
        ...
        logger.debug("Request to OSM API: " + buildQuery(pitchType));
    ...
    private String buildQuery(PitchType pitchType) {
        ...
        querySb.append("nwr(area)[\"leisure\"=\"").append(pitchType.getLeisureType())
                .append("\"][\"sport\"=\"").append(pitchType.getOsmName()).append("\"];");
